...
<body>
    ...
    <main>
        ...
        <section class="basic_page_headline container">
            <h5>Collection of Metropolitan University</h5>
        </section>
            ...
            <table class="table table-hover text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="edit.php?resource_id=<?php echo $row["resource_id"] ?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                        <a href="delete.php?resource_id=<?php echo $row["resource_id"] ?>" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
                        </td>
                    </tr>
                    <?php
                    }
