                        ...
                        <div class="dashboard_body_single">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    <li><a class="dropdown-item" href="../resource/resource_page.php">View & Edit Resources</a></li>
                                    <li><a class="dropdown-item" href="../resource/add-new.php">Register New Member</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
